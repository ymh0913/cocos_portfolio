...
TutorialMonster::TutorialMonster() {
  ...
  _orc = Sprite::create("TutorialScene/Monster/Orc/orc_warrior_1_idle_00.png");
  _orc->setScale(1.5f);
  auto orcIdleAnimation = Animation::create();
  orcIdleAnimation->setDelayPerUnit(0.15f);
  orcIdleAnimation->addSpriteFrameWithFile("TutorialScene/Monster/Orc/orc_warrior_1_idle_00.png");
  orcIdleAnimation->addSpriteFrameWithFile("TutorialScene/Monster/Orc/orc_warrior_1_idle_01.png");
  orcIdleAnimation->addSpriteFrameWithFile("TutorialScene/Monster/Orc/orc_warrior_1_idle_02.png");
  orcIdleAnimation->addSpriteFrameWithFile("TutorialScene/Monster/Orc/orc_warrior_1_idle_03.png");
  orcIdleAnimation->addSpriteFrameWithFile("TutorialScene/Monster/Orc/orc_warrior_1_idle_04.png");
  orcIdleAnimation->addSpriteFrameWithFile("TutorialScene/Monster/Orc/orc_warrior_1_idle_05.png");
  orcIdleAnimation->addSpriteFrameWithFile("TutorialScene/Monster/Orc/orc_warrior_1_idle_06.png");
  orcIdleAnimation->addSpriteFrameWithFile("TutorialScene/Monster/Orc/orc_warrior_1_idle_07.png");
